...
class _SignUnPageState extends State<SignUnPage> with TickerProviderStateMixin {
  ...
  late Animation<Offset> _slideFromBottomMore;
  ...
  void _setupAnimations() {
    ...
    _slideFromBottomMore = Tween<Offset>(
  ...
  Widget _buildParticles() {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return CustomPaint(
          painter: _SignUpParticlePainter(
...
// Particle Painter for sign up screen
class _SignUpParticlePainter extends CustomPainter {

  _SignUpParticlePainter({required this.progress});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var i = 0; i < 18; i++) {
      ...
      final animatedX = baseX + sin((progress * 2 * pi) + i) * 12;

      final distFromCenter = (animatedY / size.height - 0.5).abs();
      final opacity = (1.0 - distFromCenter * 2).clamp(0.0, 0.35);
  ...
  @override
  bool shouldRepaint(covariant _SignUpParticlePainter oldDelegate) {
